              ...
              <div class="content_wrap">
                  ...
                  <section class="single_team_post_description">
                      ...
                      <a href="#"
                          ...
                          data-bs-toggle="modal" data-bs-target="#athletesFormModal">Register
                          Now</a>
                  </section>
              </div>
              <!-- /Single team info -->
  ...
  <!-- Modal -->
  <div class="modal fade" id="athletesFormModal" tabindex="-1" aria-labelledby="athletesFormModalLabel"
      aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered modal-xl modal-dialog-scrollable">
          <div class="modal-content ">
              <div class="modal-header">
                  <h1 class="modal-title fs-5" id="athletesFormModalLabel">Athletes Registration</h1>
