            ...
            <article class="post_item post_item_single_team post_featured_left team">
                ...
                <div class="content_wrap">
                    <section class="post_featured single_team_post_featured">
                        <div class="post_thumb" data-image="{{ url('frontend/images/event1.jpg') }}" data-title="Shannon Lorenz">
                            <a class="hover_icon hover_icon_view" href="{{ url('frontend/images/event1.jpg') }}" title="Shannon Lorenz">
                                <img alt="Shannon Lorenz" src="{{ url('frontend/images/event1.jpg') }}">
                            </a>
                        </div>
                    </section>
