                                            ...
                                            @endif
                                                ...
                                                enctype="multipart/form-data" id="contactForm"
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-12">
                                                            <div class="mb-3">
                                                                <label for="mobile_no" class="form-label text-white">Mobile Number</label>
                                                        ...
                                                        <div class="col-lg-12">
                                                            <div class="mb-3">
                                                                <button type="submit"
                                                                    class="sc_button sc_button_square sc_button_style_filled sc_button_size_small margin_top_small margin_bottom_null" onClick="{{ route('addContactUs') }}">
                                                                   Send Message
                                                                </button>
