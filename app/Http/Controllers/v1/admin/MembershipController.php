...
class MembershipController extends Controller
{
    public function createMembership(Request $request): JsonResponse
    {
        ...
        try{
            ...
            $addpMembership = new Membership();

            $addpMembership->name=$request->name;
            $addpMembership->description = $request->description;
            $addpMembership->type=$request->type;
            $addpMembership->days=$request->days;
            $addpMembership->mrp=$request->mrp;
            $addpMembership->selling_price=$request->selling_price;
            $addpMembership->is_active=$request->is_active;
            $addpMembership->discount=$request->discount;

                $addpMembership->save();

                return $this->sendResponse($addpMembership->id,'Membership uploaded successfully',true);
    ...
    public function updateMembership(Request $request): JsonResponse
    {
        try {
            ...
            if ($request->filled('discount')) {
                $updateMembership->discount= $request->discount;
            }
